...
class TestClassC : public ConfigObject
{
    ...
    Q_PROPERTY(ConfigObjectArray *testClassBArray READ testClassBArray)
    Q_PROPERTY(int intValue READ intValue WRITE setintValue NOTIFY intValueChanged)

public:
    Q_INVOKABLE TestClassC(QObject *parent = nullptr)
    {
        ...
        m_testClassBArray = new ConfigObjectArray(&TestClassB::staticMetaObject, this);
    ...
    ConfigObjectArray *testClassBArray() const
    {
        return m_testClassBArray;
    }
...
private:
    ...
    int m_intValue = 5;
    ConfigObjectArray *m_testClassBArray;
};
...
public:
    Q_INVOKABLE TestClassE(QObject *parent = nullptr) : ConfigObject(parent)
    {
...
private:
    ...
    int m_editableInt = 4;
    int m_optionalInt = 3;
    double m_optionalDouble = 2;
    double m_editableDouble = 1;
    QString m_editableString;
    QString m_optionalString;
    bool m_editableBool = false;
};
